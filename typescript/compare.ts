...
function compareValues(value1:any, value2:any):number {
...
function compareArrays(a1:any[], a2:any[]):number {
...
function compareValuesAsNumber(value1:any, value2:any):number {
    let number1 = (value1) ? Number(value1) : 0;
    let number2 = (value2) ? Number(value2) : 0;
    return compareValues(number1, number2);
}

function compareValuesAsString(value1:any, value2:any):number {
...
// compare arrays from left to right (a1>a2=1, a1<a2=-1, else 0)
function compareArraysAs(a1:any[], a2:any[], method:any):number {
