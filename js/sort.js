...
function bubbleSort(items) { // small list, n^2 efficiency
...
function quickSort(items) { // large list, log n efficiency
    ...
    function _recur(items, left, right, priorState=undefined) {
        let middle;
        if (items.length > 1) {
